...
urlpatterns = [
    ...
    path("menu/editar/cafes/<id>/", vista_edit_cafe, name= "app_tienda-editar-cafe"),
    path("menu/editar/tortas/<id>/", vista_edit_torta, name= "app_tienda-editar-torta"),
    path("menu/editar/bebidas/<id>/", vista_edit_bebida, name= "app_tienda-editar-bebida"),
    path("menu/editar/salados/<id>/", vista_edit_salados, name= "app_tienda-editar-salados"),
    path("menu/editar/panqueues&wafles/<id>/", vista_edit_pw, name= "app_tienda-editar-Panqueques y Waffles"),
